(function() {
     ...
     */
    function loadPly(url, onLoad, onError) {
     ...
     */
    function loadObjWithMtl(basePaths, mtlFile, objFile, onLoad, onError) {
        /*
    ...
    window.SolarApp.core.assets = {
        loadPly: loadPly,
        loadObjWithMtl: loadObjWithMtl
    };
})();